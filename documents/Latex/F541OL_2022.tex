...
\begin{document}
	...
	\lstinputlisting[caption=Regisztrációhoz használt adatok validálása és eltárolása ,label=register_validation]{codes/register_validation.php}
	...
	\lstinputlisting[caption=Token mentése és státuszkód vizsgálata,label=postman_login_test]{codes/postman_login_test.js} 
	...
	\lstinputlisting[caption=Intent indítás explicit módon adattal,label=android_intent_from_acitve_to_specify]{codes/android_intent_from_acitve_to_specify.java}
	...
	\lstinputlisting[caption=POST és GET típusú végpont definiálás,label=retrofit_end_point]{codes/retrofit_end_point.java}
