...
\begin{document}
	...
	A migráció létrehozásakor két metódust találunk: ,,up'' és ,,down''. Az ,,up'' metódus új táblák, oszlopok, indexek hozzáadására szolgál, míg a ,,down'' pedig a módosítások visszaállításra szolgál. Ahogy megfigyelhető a~\ref{user_migration} és a~\ref{event_migration} kódokban is, ha a ,,down'' metódus kerül meghívásra azokat a táblákat ahol a tábla név megegyezik, azok eldobásra kerülnek.
	...
	\lstinputlisting[caption=Felhasználói migráció,label=user_migration]{codes/migration_user.php}
	...
	Az eseményhez tartozó migrációt a~\ref{event_migration} kód részlet tartalmazza, ahol megfigyelhető a kitöltési szintaxis is. 
	...
	A modellhez tartozó implementációt a~\ref{user_modell} kód részlet tartalmazza.
