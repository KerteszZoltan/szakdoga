...
\usepackage{fancyvrb,listingsutf8,xcolor,caption,url,listing}
...
\begin{document}
	...
	\supervisor{Dr. Tajti Tibor Gábor\\Adjunktus}
	\city{Eger}
	\date{2022}
	\maketitle
	\tableofcontents
	...
	\lstinputlisting[caption=Eseményhez tartozó migrációs kód,label=event_migration]{codes/migration_event.php}
	...
	\lstinputlisting[caption=Felhasználóhoz tartozó modell,label=user_modell]{codes/modell_user.php}
	...
	Az e-mailek-hez tartozó nézet felépítését az új esemény esetén kiküldött e-mail nézetet szemlélteti, a~\ref{email_view}-es kódrészletben, mivel itt kezelünk adatot is. 
	
	\lstinputlisting[caption=Új eseményhez tartozó e-mail felépítése,label=email_view]{codes/email_view.php}
	...
	\lstinputlisting[caption=Regisztrációhoz használt adatok validálása és eltárolás ,label=register_validation]{codes/register_validation.php}
	...
	\lstinputlisting[caption=Felhasználói adat frissítés,label=user_crud_update]{codes/user_crud_update.php}
	...
	\lstinputlisting[caption=Felhasználó törlése,label=user_crud_delete]{codes/user_crud_delete.php}
	...
	\lstinputlisting[caption=Esemény mentése,label=event_crud_store]{codes/event_crud_store.php}
	...
	A fent leírt folyamatot és az aktív esemény szűrési feltételei a~\ref{event_crud_active_read}-as kódrészletben látható.
	
	\lstinputlisting[caption=Aktív események lekérdezése,label=event_crud_active_read]{codes/event_crud_active_read.php}
	...
	\lstinputlisting[caption=Eseményhez tartozó levél küldő kontroller,label=event_mail_controller]{codes/event_mail_controller.php}
	...
	\lstinputlisting[caption=API-hoz használt útvonalak,label=api_routes]{codes/api_routes.php}
	...
	Erre példa a~\ref{android_intent_from_add_to_main} kódrészletben látható, ahol az esemény hozzáadáshoz tartozó activity-ről lépünk tovább a bejelentkezés után használt főképernyőre.
	
	\lstinputlisting[caption=Intent indítás,label=android_intent_from_add_to_main]{codes/android_intent_from_add_to_main.java}
	...
	\lstinputlisting[caption=Eseményhez tartozó migrációs kód,label=retrofit_end_point]{codes/retrofit_end_point.java}
